document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, rule) {
      ...
      const messages = {
        ...
        minlength:
          label +
          ' must be at least ' +
          field.getAttribute('data-minlength') +
          ' characters.',
      };
    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('data-minlength') && value.trim() !== '') {
        const min = field.getAttribute('data-minlength');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '8143e8c0-0252-4629-9dba-b9b5dbbb559f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '8143e8c0-0252-4629-9dba-b9b5dbbb559f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '8143e8c0-0252-4629-9dba-b9b5dbbb559f';
